...
import { saveAddedToCart, saveCart, saveDeletedFromCart, saveProducts, saveShowModal, clearCart, saveWishlist } from './actions';
...
export const clearCartInfo = (values) => (dispatch, getState) => {
    ...
    console.log('Details info: ', values, 'Cart info: ', cartList);
